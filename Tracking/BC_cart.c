...
void s_step_adj(void)
{
    ...
    while(Middle_switch_off)
    {
        if(Left_switch_on) stop_step+=10;
        if(Right_switch_on) stop_step-=10;
